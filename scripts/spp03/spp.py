...
from albumentations import (Cutout, Compose, Normalize, RandomRotate90, HorizontalFlip, RandomBrightnessContrast, 
                           ...
                           JpegCompression, Lambda, NoOp, CenterCrop, Resize
                           )
...
class DFakeDataset(Dataset):
    def __init__(self, df, imgdir, aug_ratio = 5, train = True, labels = True, maxlen = 32):
        self.data = df.copy()
        ...
        self.transform = trn_transforms if train else None
