...
for epoch in range(EPOCHS):
    ...
    trndataset = DFakeDataset(sortDfDim(trndf, size_clip = SIZE, bsize = 16), 
                              IMGDIR, train = True, val = False, labels = True, maxlen = 32)
    valdataset = DFakeDataset(sortDfDim(valdf, size_clip = SIZE, bsize = 16), 
                              IMGDIR, train = False, val = True, labels = False, maxlen = 32)
