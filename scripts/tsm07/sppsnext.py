...
parser.add_option('-v', '--stop', action="store", dest="stop", help="Stop the epochs", default="99")
parser.add_option('-w', '--dropout', action="store", dest="dropout", help="Skip every k frames", default="0.5")
...
from tsm import TSN
model = TSN(num_class=1, num_segments=NSEGMENT, modality='RGB', dropout=DROPOUT, \
