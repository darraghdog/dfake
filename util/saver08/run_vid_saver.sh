...
do
    bsub  -q low2 -gpu "num=$N_GPU:mode=exclusive_process" -app gpu -n =$N_GPU  -env LSB_CONTAINER_IMAGE=darraghdog/kaggle:dfake1 \
            ...
            --imgpath data/mount/npimg08 --size $SIZE --startsize 640 --wtspath weights --fps 8"
done
