...
# https://github.com/google-research/google-research/blob/master/bitempered_loss/loss.py
import torch
...
def bi_tempered_logistic_loss(activations, labels, t1, t2, label_smoothing=0.0, num_iters=5, reduction='mean'):
    ...
    Returns:
      A loss tensor.
    """
    # print(activations.dtype, activations.shape, activations)
...
class BiTemperedLoss(torch.nn.Module):
    def __init__(self, T1=1.0, T2=1.0, smooth=0.0, reduction='mean'):
    ...
    def forward(self, x, target):
        return bi_tempered_logistic_loss(x,
                                         target,
